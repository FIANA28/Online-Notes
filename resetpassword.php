...
<label for='password'>Enter your new Password:</label><input type='password' name='password' id='password' placeholder='Enter Password' class='form-control'>
</div>
<div class='form-group'>
<label for='password2'>Re-enter your new Password:</label><input type='password' name='password2' id='password2' placeholder='Enter Password' class='form-control'>
</div>
<input tyle='submit' name='passwordreset' class='btn btn-success btn-lg' value='Reset Password'>
</form>";
?>
        </div>
    </div>
        ...
        <!-- Sctipt for Ajax Call to storeresetpassword.php which processes form data -->
        <script>
