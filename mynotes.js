$(function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $('#alert').fadeIn();
                    ...
                    $("textarea").val("");
                    //show hide elements
                    showHide(["#notePad", "#allNotes"], ['#notes', "#addNote", "#edit", "#done", "#span"]);
                    $("textarea").focus();
                }
            },
            error: function(){
    ...
    $("#allNotes").click(function(){
        $.ajax({
            ...
            success: function (data){
                $('#notes').html(data);
                showHide(["#addNote", "#edit", "#notes", "#span"], ["#allNotes", "#notePad"]);
                clickonNote(); clickonDelete();
            }, 
            error: function(){
                $('#alertContent').text("There was an error with the Ajax Call. Please try again!");
    ...
    $("#done").click(function(){
        ...
        //show hide elements
        showHide(["#edit", "#span"], [this, ".delete"]);
    });
    ...
    $("#edit").click(function(){
        ...
        //show hide elements
        showHide(["#done", ".delete"],[this, "#span"]);
    });
