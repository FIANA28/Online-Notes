...
if(!$result){
    echo '<div class="alert alert-danger">Uuden sähköpostiosoiteen päivittämisessä ja hakemisessa tapahtui virhe.</div>';
   }  
   else {
        echo '<div class="alert alert-success">Sähköpostiosoite päivitettiin!</div>'; 
