...
if(!$result){
        echo '<div="alert alert-warning">An error occured!</div>';
        exit; 
}
...
if($result = mysqli_query($link, $sql)){
        if(mysqli_num_rows($result)>0){
                ...
                echo "<div class='alert alert-warning' role='alert'><strong>You have not yet created any notes!</strong></div>"; exit;   
        }
}else{
        echo "<div class='alert alert-warning' role='alert'>An error occured!</div>"; exit;
